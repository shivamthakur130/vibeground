...
import NoticeImg from '@/assets/images/svg/notificatopn.svg';
		...
		<div className="flex justify-between items-center">
			...
			<div className='flex'>
				<div className='flex mr-6'>
					<input className='placeholder:text-111 bg-d9d9d9 rounded-[50px] px-8 py-3 mr-8' type='text' placeholder='Search' />
				...
				<div className='flex items-center'>
					...
					<div className="flex items-center">
						<span className='mr-2 font-PoppinsBold text-22px'>Mathew</span><Image src={User} className="shrink-0" alt={''} />
					</div>
