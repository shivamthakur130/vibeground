...
const Billing = () => {
	return (
		<div className="Billing max-w-4xl mx-auto mt-24 mb-40">
					...
					<div className="mt-6">
						...
						<div className="flex justify-between mt-10">
							<Link href="/account/welcome">
								<button className="btn btn-default px-7 py-3 bg-2f2f2f text-white rounded-lg self-center transition-all duration-300 active:bg-303030 ">
									Confirm Purchase
								</button>
							</Link>
