...
const Plan = () => {
	return (
		<div className="Plan max-w-[700px] mx-auto mt-24 mb-40">
			...
			<div className="mx-auto grid grid-flow-col gap-8">
				<div className="px-5 pt-12 pb-5 rounded-xl relative shadow-shado min-w-[330px]">
				...
				<div className="px-5 pt-12 pb-5 rounded-xl relative shadow-shado min-w-[330px] border-2 border-[#F4BE55]">
			...
			{/* <button className="btn btn-default w-full px-24 py-6 mt-20 text-xl bg-2f2f2f text-white rounded-lg self-center">
				Continue
			</button> */}
			<div className="w-full text-center">
				<Link href="/account/billing">
					<button className="btn btn-default px-24 py-4 mt-20 text-xl text-white bg-303030 rounded-[8px] hover:bg-151515 self-center transition-all duration-300 active:bg-303030 ">
						Continue
					</button>
				</Link>
			</div>
