	...
	return (
		<div className="Email text-center max-w-4xl mx-auto mt-40 mb-40">
			...
			<div className="grid grid-cols-2 gap-6 my-6 max-w-xl mx-auto">
				<label htmlFor="dropzone-file" className="flex flex-col items-center justify-center max-w-[283px] h-52 rounded-xl bg-[#f9f9f9] cursor-pointer">
					<div className="flex flex-col items-center justify-center pt-5 pb-6">
						<Image src={Upload} alt='#' />
					</div>
					<input id="dropzone-file" type="file" className="hidden" />
				</label>
				<label htmlFor="dropzone-file2" className="flex flex-col items-center justify-center max-w-[283px] h-52 rounded-xl bg-[#f9f9f9] cursor-pointer">
					<div className="flex flex-col items-center justify-center pt-5 pb-6">
						<Image src={Upload} alt='#' />
					</div>
