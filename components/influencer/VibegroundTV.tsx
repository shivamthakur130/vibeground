...
const VibegroundTV = () => {
  return (
    <PageWrapper>
      <div className="Experience mx-auto  sm:mt-24 sm:mb-24 px-5">
        ...
        <div className="space-y-4 mb-10 text-lg">
          <p>
            ...
            like you{"'"}
            ve never experienced before. Immerse yourself in this unique world
            and get ready to experience something truly special.
          </p>
