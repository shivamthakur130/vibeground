...
const ManageImages = () => {
	return (
		<div className="ManageImages max-w-7xl px-5 mx-auto mt-32 mb-32">
			<h2 className="text-5xl font-PoppinsBold text-111 mb-6">
				Manage my Images
			</h2>
			...
			<div className="flex items-center space-x-7">
				...
				<div className="flex items-center justify-center">
					<label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-40 h-40 rounded-xl cursor-pointer bg-[#f9f9f9] hover:bg-gray-100">
			...
			<div className="flex items-center space-x-7">
				<div className='relative bg-black group cursor-pointer rounded-md'>
					<Image className="w-40 h-40 group-hover:opacity-80" src={Video1} alt="Neil image" />
				...
				<div className='relative bg-black group cursor-pointer rounded-md'>
					<Image className="w-40 h-40 group-hover:opacity-80" src={Video2} alt="Neil image" />
					<div className="w-40 h-40 absolute top-0 left-0 right-0 flex justify-center items-center" >
				...
				<div className='relative bg-black group cursor-pointer rounded-md'>
					<Image className="w-40 h-40 group-hover:opacity-80" src={Video3} alt="Neil image" />
					<div className="w-40 h-40 absolute top-0 left-0 right-0 flex justify-center items-center" >
