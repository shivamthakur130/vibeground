    ...
    <PageWrapper>
      <div className="Email mx-auto  sm:mt-24 sm:mb-24 px-5">
        <h2 className="sm:text-5xl text-3xl font-PoppinsBold text-111 flex  mb-10 pt-20 sm:pt-0">
          ...
          <div className="ml-10">Advertising</div>
        </h2>
        <div className="space-y-4 text-lg mb-10">
          <p>
            {" "}
            Discover the ultimate opportunity to present yourself and your
            profile exclusively and strategically on Vibeground! Here you will
            find the perfect platform to showcase your unique personality,
            talent and beauty. If you are looking for the best way to market
            yourself, there is no better place than Vibeground.
          </p>

          <p>
            With Vibeground, you can make sure you{"'"}re seen by the right
            audience. We offer you tools and features to increase your reach and
            showcase yourself in our community.
          </p>

          <p>
            So don{"'"}t waste any time and take advantage of the exclusive
            opportunity to stand out on Vibeground and increase your
            international reach. Welcome to Vibeground Advertising.
          </p>
        </div>
