...
const Newcomer = () => {
	return (
		<div className="Email text-center max-w-xl mx-auto mt-40 mb-40">
			...
			<p className='text-xl'>This is a special one-time experience that can only be done once</p>
			...
			<p className='text-xl'>This feature is available only for verified pro subscriptions</p>
