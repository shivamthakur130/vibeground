...
import { signUp } from '@/services/collaborate.service';
...
// You can use the 'germanCities' array in your code as needed
	...
	return (
		<PageWrapper>
			<div className="Email text-left px-5 max-w-xl mx-auto sm:mt-10 sm:mb-24 mb-20 ">
				<div className="px-4">
					<h2 className="sm:text-3xl text-2xl font-PoppinsBold text-111 flex items-center mb-2 sm:mt-10 pt-20 sm:pt-0">
