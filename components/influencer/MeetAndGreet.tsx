    ...
    <PageWrapper>
      <div className="max-w-7xl mx-auto">
        <div className="mx-auto sm:mt-10 sm:mb-24 mb-20 px-5">
          ...
          <div className="bg-gray-950  flex items-center justify-center rounded-md">
          ...
          <div className=" ">
            ...
            <ul className="list space-y-2 font-PoppinsRegular text-gray-700">
              <li>
                ...
                opportunity awaits you here to register for unique encounters
                with your loyal fans. Immerse yourself in a world where
                authenticity, closeness and the experience of something special
                take center stage.
              </li>
              <li>
                ...
                opportunity to connect with their fans on a personal level,
                which is precisely why we offer these exclusive Meet & Greets.
              </li>
              <li>
                ...
                earn money. These encounters are not only a chance to meet fans
                up close, but also an opportunity to raise your profile and
                promote your career through Vibeground TV{"'"}s media support.
              </li>
              <li>
                Apply now for Meet & Greet and experience unforgettable moments
                in an inspiring community. Here you will find real closeness to
                your fans and have the opportunity to build a special connection
                with them.
              </li>
