      ...
      <div className="Experience max-w-7xl px-5 mx-auto sm:mt-24 sm:mb-24 mt-10 mb-20">
        ...
        <div className="px-4 pb-4">
          <ul className="list space-y-4 font-PoppinsRegular text-lg text-gray-700">
            ...
            <li>
              Our {"'"}Meet & Greet{"'"} events are much more than just
              encounters - they are experiences that create memories that will
              last a lifetime. We firmly believe that models should take the
