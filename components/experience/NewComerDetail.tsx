		...
		<div className="Experience max-w-7xl px-5 mx-auto mt-10 md:mt-24 mb-24">
			...
			<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-16">
				...
				<div className='space-y-5 md:space-y-8'>
					...
					<p className='p-3 bg-[#f9f9f9] text-656565 rounded-xl'>“Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod temporin cididunt ut labore et dolore magnaaliqua. Ut enim ad minim veniam,”</p>
					...
					<div className=''>
						...
						<span className='text-base md:text-[32px] text-656565'>Toys, Bondage</span>
					</div>
