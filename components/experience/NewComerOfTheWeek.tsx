    ...
    <PageWrapper>
      <div className="Experience max-w-7xl px-5 mx-auto mt-10 md:mt-24 mb-24">
        ...
        <div className="space-y-4 mb-10 text-lg">
          ...
          <p>
            Here, you will find a unique opportunity to choose your favorite
            creators as the Newcomer of the Month through interactive voting.
          </p>
          <p>
            The interactive voting function is the heart of the vote for the
            Newcomer Of The Month. As a member of our community, you have the
            power to determine the Newcomer Of The Month by casting your votes
            for your favorites. Each month brings forth new talents, and you can
            actively contribute to giving them more attention and recognition!
          </p>
          <p>
            The winners will receive fame and honor, and you can support them in
            achieving that! Who will be next to win the coveted title Newcomer
            Of The Month?
          </p>
        </div>
